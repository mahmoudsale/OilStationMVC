...
namespace OilStationMVC.Controllers
{
    ...
    public class StationsController : Controller
    {
        ...
        {
            List<Station> lst = await repository.ListAsync();
            return View(lst);
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Create(Station model)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Edit(int Id, Station model)
        {
            if (ModelState.IsValid)
            {
                try
